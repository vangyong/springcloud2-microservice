...
import cn.segema.cloud.shrio.vo.UserPersonalVO;
...
public interface UserRepository extends JpaRepository<User, String> {
	 ...
	 @Query("select new cn.segema.cloud.shrio.vo.UserPersonalVO(u.userId,u.userName,u.nickName,p.personalId,p.personalName)"
